...
test('core API smoke test covers auth, content, devices, schedules, and player resolution', async () => {
  ...
  assert.equal(playerManifest.data.version, '1.6.4');
  ...
  assert.equal(deviceDetail.data.device.latest_player_version, '1.6.4');
  ...
  assert.equal(updatePlayers.data.latest_player_version, '1.6.4');
